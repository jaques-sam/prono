...
mod tests {
    ...
    fn test_question_conversion() {
        ...
        let super_question: crate::Question = question.into();
        assert_eq!(super_question.question, "What is your name?");
        assert_eq!(super_question.answer, crate::Answer::new_text());
    }
    ...
    fn test_survey_conversion() {
        ...
        let super_survey: super::Survey = survey.into();
        assert_eq!(super_survey.id, 1);
        assert_eq!(super_survey.description, "Test Survey");
        assert_eq!(super_survey.questions.len(), 2);
    }
